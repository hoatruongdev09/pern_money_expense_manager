                ...
                <tbody>
                    <tr className="table-info">
                        <td>
                            ...
                            <span className="badge bg-info text-dark">Income</span>
                        </td>
                    ...
                    <tr className="table-danger">
                        <td>
                            <div className="text-bold-500 float-left">Michael Right</div>
                            <span className="badge bg-danger text-dark">Expense</span>
                        </td>
                        <td style={{ textAlign: 'right' }}>
                            <div> $500</div>
                    ...
                    <tr className="table-warning">
                        <td>
                            <div className="text-bold-500 float-left">Michael Right</div>
                            <span className="badge bg-warning text-dark">Transfer</span>
                        </td>
                        <td style={{ textAlign: 'right' }}>
                            <div> $500</div>
                            <span className="badge bg-secondary">Cash</span>
