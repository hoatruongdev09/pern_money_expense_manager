    ...
    <Fragment>
      <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <ul className="navbar-nav ml-auto">
          ...
          <li className="nav-item dropdown no-arrow user-dropdown-class">
            <a
              className="nav-link dropdown-toggle"
              href="#"
              id="userDropdown"
            ...
            >
              <span className="mr-2 d-none d-lg-inline text-gray-600 small">
                {userInfo != null ? userInfo.user_name : ""}
              </span>
              <img
            ...
            <div
              className="dropdown-menu dropdown-menu-right shadow animated--grow-in user-dropdown-class"
